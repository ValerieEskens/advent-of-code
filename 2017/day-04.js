...
input.forEach(function(passphrase, key) {
	let valid = true
	...
	passphraseArr.forEach(function(word, key) {
		...
		sortedPassphraseArr.push(sortedWord)
	})

	sortedPassphraseArr = sortedPassphraseArr.slice().sort()
	sortedPassphraseArr.forEach(function(word, key) {
		if (sortedPassphraseArr[key + 1] == sortedPassphraseArr[key]) {
			valid = false
			return false
		}
	})
