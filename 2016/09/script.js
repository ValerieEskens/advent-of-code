...
function check(string, startAt) {
    var indexToStartFrom = startAt;
    var iOpeningbracket = string.indexOf(openingbracket, indexToStartFrom);
    if (iOpeningbracket !== -1) {
        var lengthBeforeOpeningbracket = string.substr(indexToStartFrom, iOpeningbracket).length;
        var iMultiplier = string.indexOf(multiplier, iOpeningbracket);
        var iClosingbracket = string.indexOf(closingbracket, iOpeningbracket);
        var nrOfCharsToRepeat = parseInt(string.substr(iOpeningbracket + 1, iMultiplier));
        var repeats = parseInt(string.substr(iMultiplier + 1, iClosingbracket));
        var charsToRepeat = string.substr(iClosingbracket + 1, nrOfCharsToRepeat);
        var length_1 = nrOfCharsToRepeat * (repeats - 1);
        var endI = iClosingbracket + nrOfCharsToRepeat;
        return {
        ...
        var charsToRepeat = string.substr(indexToStartFrom);
        var charsToRepeatLength = charsToRepeat.length;
        return {
            charsToRepeat: charsToRepeat,
            repeats: 1,
