+kfbo++++++++ruqirn+
+t++++xpbdscmdoug+
...
+rdpvqskmihqaw+
+p++gwdhtqnpgthod+
+nwnuf++++yebycearom++nqym++++++sii++++le+
+alda++ptspo++wkkv++zoi++hkb++vnntyd+
+ixpgpfzbqv+
+znui++++fzn++++qozabh++rva++pv+++++
+e++zswmwuk+
+hcccygwfa+
+ngmace++rtyllolr++++++bw+
+++c++jyufbry++ryo++xpo++++ecninfeckh++s+
+hdnpngtuc++dzbvvosn++++fwtpzbrt+
+hesbpd+++++
+dsdbstuzrdfmrnyntufs++dmv+
+d++++ibcwhcvkt+
+fvzwrsfjdqdmy++++v+
+ns++dqafz++lkyoflnazv++mn++++++o++yj++e+
+dypilgbwzccayxa++bnmuernx+
+q++++ztqrhreb++++kxfeyodqb+
+iz++++qjxqulaawuwz++rqmpcj++yel+
+z++++pq++++y++++zpjtn+
+ifxqvivp++kiiftdoe+
+jxzebj++++++++qr++ecglcutuoyywqumcs++kk+
+q+
+yob++++qmpuwexptczbkrl+
+cjiavv++uudpozvibyycnmxhxpxmpjoz+
+xro++uiqyrcid+
...
+d++neiec+
+tqyrqvwyvmz++pzgzzcqsqsrgbqbtapoz+
+r++xvocpeuxfxslgueb++++kzyyie++aoec+
+++du++uirlhcbgv++cjqhfreqnvn+
+zp++++++++++pbjwhrjtmiba+
+++cv+++
...
+klrmafjzandiddodgz+
+xipzhqzhvlpykzcuppx+
+zdvrvn++++mtfvpylbn++++sxcznrzugwznl+
+ody++pvm++kpjiudzhxazirgxzvumeat++o+
+kllvhdp++prjikzrrc++adgpegc++++gk+
+sqtpug++++aauxaamw+
+wegxxrrxdvpivrqievfeokmnojsk+
...
+yialiuzwix+
+yp++ndxgwzml++bt+
+lpcjxmggfsy++szbxccarjkqzasqkb++++d+++++
+x+
+mgakc+
+vjieunoh++++fjwx+
+erbvv++qulsd+
+mimycrbfhqkarmz+
+tihfbgcszuej++c++++voqskkhbgpaddioo+
+mziavkwrmekriqghw+
...
+nywbv+++
+twc++ehfqxhgomgrgwpxyzmnkioj+
+qludrkkvljljd++xvdeum+++++'

strPlusSplit = strPlus.split(' ')
strPlusTot = 0
for s in strPlusSplit
    strPlusTot += s.length*1
console.log "strPlusTot", strPlusTot

strSplit = str.split(' ')
strTot = 0
for st in strSplit
    strTot += st.length*1-2
console.log "strTot", strTot

console.log "strPlusTot - strTot =", strPlusTot - strTot


str2PlusSplit = strPlus.replace(' ', '')
console.log "str2PlusTot", str2PlusSplit.length

str2Split = str.replace(' ', '')
console.log "str2Tot", str2Split.length

console.log "str2PlusTot - str2Tot =", str2PlusSplit.length - str2Split.length

for num in [0..strSplit.length]
    console.log strSplit[num]
    console.log strPlusSplit[num]
    console.log "\n"